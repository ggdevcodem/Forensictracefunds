...
export default function WalletDecryptionPage() {
  return (
    <ServiceTemplate
      ...
      subtitle="Secure wallet decryption and cryptocurrency key recovery"
      description="Our wallet decryption service helps you regain access to your cryptocurrency assets. Whether you've forgotten your password, lost your recovery key, or need to decrypt legacy wallets, our expert technicians can help."
      capabilities={[
        'Password recovery and reset',
        'Hardware wallet access restoration',
        'Legacy wallet support (pre-2015)',
